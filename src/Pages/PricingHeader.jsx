                        ...
                        <div className="home_header_component">
                          <div className="w-layout-grid home_header_layout">
                            <div className="home_header_left-wrapper">
                              ...
                              <div className="home_header_content">
                                <div className="padding-section-large">
                                  ...
                                  >
                                    Get Accurate Cost Estimation for Your Project!<br></br>
                                  </h1>
                                  <div className="spacer-small"></div>
                                  <p slide-in-header="" className="text-size-medium">
                                    Do you want to know how much it cost to develop an app or business website? Our calculator will help you estimate the cost in just a few minutes. Contact our top mobile app and web development company to avail reasonable development assistance.
                                  </p>
                            ...
                            <img
                              ...
                              slide-in-header=""
                              alt=""
                              className="pricing_header_image"
                            />
                          </div>
                        </div>
                      </div>
