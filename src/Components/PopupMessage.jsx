        ...
        <div className="why_item-link" style={{ padding: '2rem' }}>
          {showSuccess ? (
            ...
            <div className="popup-content-row">
              ...
              <div className="popup-image-column">
                <img
                  src="https://res.cloudinary.com/ddnb10zkq/image/upload/v1771247218/c3220579-95a9-42c7-9475-7f7ab156810f.png"
                  alt="Team discussing fintech product ideas"
