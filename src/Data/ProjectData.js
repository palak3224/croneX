...
export const ProjectData = [
  ...
  },
  {
    ...
    features: [
      ...
      "Restaurant and food menu listing layout",
      "Easy navigation and structured content flow",
  ...
  },
  {
    ...
    features: [
      "Clean and modern UI inspired by organic and natural food branding",
      "Web and mobile-friendly design with consistent user experience",
      "Category-based product browsing for quick discovery",
      "Visually rich product listings with clear pricing and offers",
      "Simple and intuitive shopping flow from browsing to checkout",
    ],
    images: [projectImg6, projectImg7, projectImg8],
  ...
  },
  {
    ...
    features: [
      "Premium and modern UI tailored for fashion eCommerce brands",
      "Fully responsive design for desktop, tablet, and mobile devices",
      "Category-based browsing for men's and women's fashion",
      "Visually rich product cards with pricing, ratings, and discounts",
